...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("9jbyjdzg")

  // remove
  collection.schema.removeField("xqldokkq")

  // remove
  collection.schema.removeField("8xrniedi")

  // remove
  collection.schema.removeField("oop8hpdd")
